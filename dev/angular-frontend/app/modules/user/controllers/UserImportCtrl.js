...
app.controller('UserImportCtrl',function($scope,UserService,RoleService,$http,$rootScope,WizardHandler,$translatePartialLoader,trans){
    ...
    $scope.getFieldMap = function() {
        if($scope.importdata.file !='') {
            ...
            swal($rootScope.selectFileError);//define in AdminCtrl
            return false;
        }
    };
