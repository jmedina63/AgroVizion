...
app
    ...
    .config(function($stateProvider,$urlRouterProvider,$locationProvider,$breadcrumbProvider,$authProvider,RestangularProvider,CacheFactoryProvider,$translateProvider,tmhDynamicLocaleProvider,NotificationProvider,$translatePartialLoaderProvider) {
        ...
        $translateProvider
            ...
            .registerAvailableLanguageKeys(['en-us', 'es-mx', 'ar-ae','pt-br'], { // register your language key and browser key find
                'en_*': 'en-us',
                'es_*': 'es-mx',
                'ar_*': 'ar-ae',
                'pt_*': 'pt-br'
         ...
         * UI-Router config
         */
        // $locationProvider.html5Mode(true); // Enable Html5mode URL template without (#) hash  
        ...
        $stateProvider
            .state('register', {
                url: '/register',
                templateUrl: 'app/shared/views/register.html',
                controller:'RegisterCtrl',
                resolve: {
                    dep: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                            return $ocLazyLoad.load(['recaptcha','sweet-alert2','app/shared/controllers/RegisterCtrl.js']);
                        }]
                }
            })
            .state('register-verify', {
                url: '/register/verify/:code',
                templateUrl: 'app/shared/views/verify.html',
                controller:'VerifyCtrl',
                resolve: {
                    dep: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                            return $ocLazyLoad.load(['sweet-alert2','app/shared/controllers/VerifyCtrl.js']);
                        }]
                }
            })
            .state('forget-password', {
                ...
                resolve: {
                    dep: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                            return $ocLazyLoad.load(['sweet-alert2','app/shared/controllers/ForgetPassCtrl.js']);
                        }]
                }
            })
            ...
            .state('admin.users',{
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['sweet-alert2','ui-bs-paging','UserServiceModule']).then(
                                function(){
            ...
            .state('admin.importUser',{
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['dropzone','sweet-alert2','RoleServiceModule','UserServiceModule','angular-wizard']).then(
                                function(){
            ...
            .state('admin.roles',{
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['sweet-alert2','ui-bs-paging','RoleServiceModule']).then(
                                function(){
            ...
            .state('admin.createPermission',{
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['sweet-alert2','ui-bs-paging','PermissionServiceModule']).then(
                                function(){
            ...
            .state('admin.tasks',{
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['sweet-alert2','ui-bs-paging','TaskServiceModule','yep-data-table']).then(
                                function(){
            ...
            .state('admin.categories',{
                ...
                resolve: {
                    ...
                    dep: ['trans','$ocLazyLoad',
                        function(trans,$ocLazyLoad){
                            return $ocLazyLoad.load(['summernote','sweet-alert2','CategoryServiceModule']).then(
                                function(){
            ...
            //        dep: ['trans','$ocLazyLoad',
            //            function(trans, $ocLazyLoad ){
            //                return $ocLazyLoad.load(['sweet-alert2','ui-bs-paging','SampleServiceModule']).then(
            //                    function(){
